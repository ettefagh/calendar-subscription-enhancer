...
<body>
    <div class="container">
        ...
        <footer>
            ...
            <p style="margin-top: 0.5rem; font-size: 0.75rem;"><a href="https://github.com/ettefagh/calendar-subscription-enhancer" target="_blank" style="color: inherit; text-decoration: none; opacity: 0.8;">View on GitHub</a></p>
        </footer>
    </div>
